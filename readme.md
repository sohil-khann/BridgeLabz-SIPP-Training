...
│   └── (6 total files)
│   ├── Day 5 - Difficult Problems/
│   │   ├── AutocompleteSearchSuggestions.txt
│   │   ├── DistributedLoadBalancer.txt
│   │   ├── EmployeeBonusDistributionEngine.txt
│   │   ├── HealthcareDiagnosisEngine.txt
│   │   ├── RestaurantPOSBillingSystem.txt
│   │   └── SmartGridEnergyUsageTracker.txt
│   └──
...
- Day 5: Java OOPs (Healthcare Diagnosis Engine, Restaurant POS Billing System), Data Structures & Algorithms (Distributed Load Balancer – Queue Simulation, Autocomplete Search Suggestions – Trie Implementation, Smart Grid Energy Usage Tracker, Employee Bonus Distribution Engine)
- Week 2 / Day 1: Java OOPs (Online Exam Portal, Movie Ticket Booking), Data Structures & Algorithms (Bus Route Navigator, Attendance Marker)
- Week 2 / Day 1 (Collections & Streams): Collections (Daily Tasks Organizer), Streams (Simple Word Counter)

Total Pseudo-code Problems: 30
